...
import com.nested.service.PostService;
...
public class PostController {
    ...
    @GetMapping("/subnested/{subnestedName}")
    public ResponseEntity<List<PostResponse>> getPostsBySubnested(
        ...
        List<PostResponse> posts = postService.getPostsBySubnested(subnestedName, sort, page, size, user);
        return ResponseEntity.ok(posts);
    }
